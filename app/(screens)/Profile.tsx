          ...
          },
          {
            ...
            onPress: async () => {
              try {
                ...
                navigate("(auth)"); // Navigate to the authentication screen
              } catch (error) {
                console.error("Error signing out:", error);
              }
            },
            style: "destructive", // Optional: Highlight the sign-out button
          },
        ],
        { cancelable: true } // Optional: Allow dismissal by tapping outside
      );
    };
            ...
            <View className='flex justify-between h-full w-full'>
                <View >
                    ...
                    <View className="flex flex-row justify-around">
                        ...
                        <TouchableOpacity
                        onPress={handlePresActivity}
                        className="flex justify-center items-center bg-gray-400 m-2 p-10 rounded-2xl">
                            <Svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="black" width={30} height={30}>
                ...
                <TouchableOpacity className="flex flex-row bg-slate-300 p-4 mx-10 my-10 rounded-2xl justify-between items-center"
